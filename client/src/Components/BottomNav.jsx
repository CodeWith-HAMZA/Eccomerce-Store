...
const BottomNav = () => {
     const {setIsCartOpened, IsCartOpened} = React.useContext(Context);
  const CloseCart = () => {
    setIsCartOpened(!IsCartOpened);
  };
  return (
    <div class="w-full md:hidden block h-screen">
      <section
        ...
        >
          <div id="tabs" class="flex justify-between">
            ...
            >
              ...
              <span class="tab tab-explore block text-xs">Cart</span>
            </button>
            <a
              href="#"
              class="w-full focus:text-yellow-500 hover:text-yellow-500 justify-center inline-block text-center pt-2 pb-1"
