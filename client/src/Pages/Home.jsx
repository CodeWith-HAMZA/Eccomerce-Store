...
import ForeverHeroSection from "../Components/ForeverHeroSection";
import FancyHeroSection from "../Components/FancyHeroSection";
import Content from "../Components/Content";
import { getMultipleDocs } from "../firebase/firebaseMethods";
const Home = () => {
  const { Products, setProducts, setProgress } = React.useContext(Context);
